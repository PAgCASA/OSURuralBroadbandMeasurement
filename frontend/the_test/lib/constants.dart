...
const int NUMBER_OF_PINGS_TO_SEND_INITIAL = 5;
...
const String SERVER_RESULT_REQUEST_URL = 'http://$BACKEND_SERVER:8080/api/v0/getSpeedTestResults/';
const String TEST_ID_FOR_TESTING = '072a0aa184427ef8';
const String SERVER_UPLOAD_URL_TEXT = 'http://$BACKEND_SERVER:8080/api/v0/submitSpeedTest';
